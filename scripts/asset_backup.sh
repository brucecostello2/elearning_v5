...
#
# This was `readonly LOG_FILE="/var/log/ivgs/asset_backup.log"` -- one shared file that
...
# and the reasoning. Read these with a glob: /var/log/ivgs/asset_backup.*.log
#
...
LOG_FILE="$(ivgs_log_file asset_backup)"
readonly LOG_FILE
