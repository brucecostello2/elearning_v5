...
const STATE_BADGE: Record<ModelState, string> = {
  ...
  deprecated: "bg-orange-100 text-orange-800 border border-orange-200",
  retired: "bg-gray-200 text-gray-600 border border-gray-300",
};
...
const btnSubtle =
  "inline-flex items-center rounded-md border border-gray-300 bg-white px-3 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50 disabled:opacity-50";
  ...
  return (
    <ErrorBoundary>
      <div className="min-h-screen bg-gray-50">
                    ...
                    return (
                      <React.Fragment key={m.id}>
                        ...
                        >
                          ...
                          <td className="px-4 py-3 text-gray-700">{m.stage}</td>
                          <td className="px-4 py-3 text-gray-700">{m.engine}</td>
                          <td className="px-4 py-3 text-gray-700">{m.tier}</td>
                          <td className="px-4 py-3">
                            <span
                        ...
                        {expanded === m.id && (
                          <tr className="bg-gray-50">
                            <td colSpan={9} className="px-6 py-4">
                              <div className="grid grid-cols-1 gap-4 text-xs text-gray-700 md:grid-cols-3">
                                <div>
            ...
            <div className="max-h-[90vh] w-full max-w-2xl overflow-y-auto rounded-lg bg-white shadow-xl mx-4">
              ...
              <div className="grid grid-cols-1 gap-4 px-6 py-4 md:grid-cols-2">
                ...
                <div className="flex items-center gap-2 md:col-span-2">
                  ...
                  />
                  <label htmlFor="dyn-loadable" className="text-sm text-gray-700">
        ...
        {editTarget && (
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
            <div className="max-h-[90vh] w-full max-w-lg overflow-y-auto rounded-lg bg-white shadow-xl mx-4">
              <div className="border-b border-gray-200 px-6 py-4">
                <h2 className="text-lg font-semibold text-gray-900">
        ...
        {approveTarget && (
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
            <div className="w-full max-w-lg rounded-lg bg-white shadow-xl mx-4">
              <div className="border-b border-gray-200 px-6 py-4">
                <h2 className="text-lg font-semibold text-gray-900">
