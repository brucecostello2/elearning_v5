...
const NAV_ITEMS: NavItem[] = [
  ...
  {
    /* AD-09.15 criterion 7: the library is GUI-reachable from every page, not
       a URL someone has to know. Viewer-visible because browsing brand media
       is read-only; every write inside is operator- or admin-gated, server-side
       as well as here. */
    label: "Library",
    href: "/library",
    minRole: "viewer",
