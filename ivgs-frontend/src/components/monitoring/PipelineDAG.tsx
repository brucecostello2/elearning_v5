...
const NODE_FILL: Partial<Record<PipelineStageStatus, string>> = {
  PENDING: "#F3F4F6",
  RUNNING: "#DBEAFE",
  COMPLETE: "#D1FAE5",
  FAILED: "#FEE2E2",
...
const NODE_STROKE: Partial<Record<PipelineStageStatus, string>> = {
  PENDING: "#D1D5DB",
  RUNNING: "#3B82F6",
  COMPLETE: "#10B981",
  FAILED: "#EF4444",
...
const FALLBACK_COLORS: Partial<Record<FallbackLevel, string>> = {
  L1: "#10B981",
  L2: "#F59E0B",
  L3: "#F97316",
  L4: "#EF4444",
 ...
 */
const SHORT_LABELS: Partial<Record<PipelineStage, string>> = {
